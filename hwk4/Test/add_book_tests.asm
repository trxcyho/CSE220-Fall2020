...
author: .asciiz "Founding Fathers"
books:
.align 2
.word 9 0 68
...
# Add a book to a hash table with existing values; collision with one probe required
.data 
isbn: .asciiz "9781416971700"
title: .asciiz "Out of My Mind"
author: .asciiz "Sharon M. Draper"
books:
.align 2
.word 7 3 68
# Book struct start
